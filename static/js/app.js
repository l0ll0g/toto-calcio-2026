      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div class="glass rounded-2xl p-5">
          ...
          <div class="space-y-3">
            ...
            <div><label class="tc-label">Password</label>
              <input class="tc-input" type="password" id="create-pw" placeholder="Parola d'ordine"></div>
          </div>
        ...
        <div class="glass rounded-2xl p-5">
          ...
          <div class="space-y-3">
            ...
            <div><label class="tc-label">Password</label>
              <input class="tc-input" type="password" id="join-pw" placeholder="Parola d'ordine"></div>
          </div>
